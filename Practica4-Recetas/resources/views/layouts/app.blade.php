...
<head>
    ...
    <!--Definir el yield de estilos para la instegracion del editor Trix-->
    @yield('styles')
...
<body>
    <div id="app">
        ...
        <!---Termina para agregar las categorias-->
    ...
    <!--Definir el yield de scripts para la integracion del editor Trix -->
    @yield('scripts')
</body>
</html>
