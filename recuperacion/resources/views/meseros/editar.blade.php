...
@section('content')
<h2 class="text-center mb-5">Editar informacion de mesero</h2>
<!-- Diseñar el formulario para guardar receta -->
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
    <form method="POST" action="{{ route('meseros.update', ['mesero' => $mesero->id]) }}"
    ...
    <!--Boton-->
    <div class="form-group">
        <input type="submit" class="btn btn-primary" value="Actualizar información de mesero">
    </div>
    </form>
    </div>
</div>
